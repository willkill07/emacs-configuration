...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:foreground ,zenburn-bg :background ,zenburn-magenta))))
   ...
   '(company-preview-common ((t (:inherit company-preview :foreground "#cc9393"))))
   '(company-preview-search ((t (:inherit company-preview :background "#366060"))))
   '(company-scrollbar-bg ((t (:inherit company-tooltip :background "#6f6f6f"))))
   '(company-scrollbar-fg ((t (:background "#dc8cc3"))))
   '(company-template-field ((t (:background "#5f5f5f" :foreground "#dc8cc3"))))
   '(company-tooltip ((t (:background "#5f5f5f" :foreground "#dcdccc"))))
   '(company-tooltip-annotation ((t (:inherit company-tooltip :foreground "#cc9393"))))
   '(company-tooltip-common ((t (:inherit company-tooltip :foreground "#afd8af"))))
   '(company-tooltip-common-selection ((t (:inherit company-tooltip-selection :foreground "#afd8af"))))
   '(company-tooltip-selection ((t (:inherit company-tooltip :background "#366060"))))
   ...
   ;; auto-complete
   `(popup-face ((t (:background ,zenburn-bg+3 :foreground "black"))))
   `(popup-menu ((t (:background ,zenburn-bg+3 :foreground "black"))))
   `(ac-candidate-face ((t (:background ,zenburn-bg+3 :foreground "black"))))
   `(ac-selection-face ((t (:background ,zenburn-blue :foreground ,zenburn-fg))))
   `(ac-clang-candidate-face ((t (:background ,zenburn-bg+3 :foreground "black"))))
   `(ac-clang-selection-face ((t (:background ,zenburn-blue :foreground ,zenburn-fg))))
   `(popup-tip-face ((t (:background ,zenburn-bg+1 :foreground ,zenburn-yellow))))
